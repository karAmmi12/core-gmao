...
export function MaintenanceScheduleForm({ assets, technicians, createAction, existingSchedule }: MaintenanceScheduleFormProps) {
  ...
  return (
    <DataForm
      ...
      submitLabel={isEditMode ? 'Enregistrer les modifications' : 'Créer le planning'}
      onSuccess={() => window.location.href = '/maintenance'}
    >
      {({ errors, isPending }) => (
        <>
          {/* Hidden fields */}
            ...
            <Card>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {errors?.assetId && (
                    <p className="text-red-600 text-sm mt-1">{errors.assetId}</p>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  <div className={LAYOUT_STYLES.grid2}>
                    <div>
                      ...
                      {errors?.frequency && (
                        <p className="text-red-600 text-sm mt-1">{errors.frequency}</p>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    />
                    {errors?.nextDueDate && (
                      <p className="text-red-600 text-sm mt-1">{errors.nextDueDate}</p>
                    )}
                  </div>
                </div>
              ) : (
                  ...
                  <div className={LAYOUT_STYLES.grid2}>
                    <div>
                      ...
                      {errors?.thresholdValue && (
                        <p className="text-red-600 text-sm mt-1">{errors.thresholdValue}</p>
                      )}
                    </div>
